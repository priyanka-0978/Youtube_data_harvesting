...
#Function to select channel names for user input from MongoDB
...
st.subheader(":blue[Migrating Data to a SQL Data Warehouse]")
...
if submit1:
    ...
    with st.spinner('Please wait '):
        ...
        def get_channel_details(user_input):
            ...
            projection = {"_id":0,"channel_id":1,"channel_name":1,"channel_views":1,"subscriber_count":1,"total_videos":1,"playlist_id":1,'description':1}
        ...
        def get_video_details(channel_list):
            ...
            projection = {"_id":0,"video_id":1,"channel_id":1,"video_name":1,"published_date":1,"view_count":1,"like_count":1,"comment_count":1,"duration":1,'favourite_count':1,'thumbnail':1,'caption_status':1}
...
#------------------------------Storing data into mysql database-------------------#
    ...
    #MySQL Database Connection:
        ...
        engine = create_engine('mysql+mysqlconnector://root:user_password@localhost/youtube_data_warehousing')
